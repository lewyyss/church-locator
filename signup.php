...
<body>
  ...
  <section class="vh-100 bg-image " style="background-image: url('.jpg');">
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card " style="border-radius:15px;">
              ...
              <img src="IMAGES/nathan-mullet-pmiW630yDPE-unsplash.jpg" alt="logo image" class="logo" height="70" width="70">
    ...
    <footer class="socialmedia">
       ...
       <p> All rights reserved. &copy;2022, Lewis Karanu&trade;.</p>
    </footer>
    </section>
